...
Core features include user and character management, a campaign system with AI-generated storylines, session tracking, and a procedural exploration map system. The exploration system uses narrative-aware hex maps with HexMetaV2 metadata, generating hexes dynamically based on AI narrative mentions and directional hints. A World Map system tracks user exploration. The dice rolling engine supports standard RPG dice with real-time WebSocket communication.
